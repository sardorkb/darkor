...
<div class="card">
    <h5 class="card-header">Post qo'shish</h5>
    <div class="card-body">
      <form method="post" action="{{route('post.store')}}">
        ...
        <div class="form-group">
          <label for="quote" class="col-form-label">Kvota</label>
        ...
        <div class="form-group">
          ...
          <select name="post_cat_id" class="form-control">
              <option value="">--Kategorya tanlang--</option>
        ...
        <div class="form-group">
          ...
          <select name="tags[]" multiple  data-live-search="true" class="form-control selectpicker">
              <option value="">--Teg tanlang--</option>
        ...
        <div class="form-group">
          <label for="added_by">Muallif</label>
...
<script>
    ...
    $(document).ready(function() {
      $('#summary').summernote({
        placeholder: "Qisqacha xulosani yozing.....",
          tabsize: 2,
          height: 100
      });
    });
    ...
    $(document).ready(function() {
      $('#description').summernote({
        placeholder: "To'liq izohni yozing.....",
          tabsize: 2,
          height: 150
      });
    });
    ...
    $(document).ready(function() {
      $('#quote').summernote({
        placeholder: "Kvota haqida ma'lumotni yozing.....",
          tabsize: 2,
          height: 100
      });
    });
