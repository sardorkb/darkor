...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Buyurtmalar ro'yxati</h6>
    </div>
    <div class="card-body">
      <div class="table-responsive">
          ...
          <tbody>
            ...
            @endphp 
                <tr>
                    ...
                    <td>
                        <a href="{{route('order.show',$order->id)}}" class="btn btn-warning btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="ko'rish" data-placement="bottom"><i class="fas fa-eye"></i></a>
        ...
        @else
          <h6 class="text-center">Buyurtmalar topilmadi!!! Iltimos avval maxsulotga buyurtma bering</h6>
        @endif
      </div>
    </div>
</div>
