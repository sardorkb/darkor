...
<div class="card">
    <h5 class="card-header">Kupon qo'shish</h5>
    <div class="card-body">
      <form method="post" action="{{route('coupon.store')}}">
        ...
        <div class="form-group">
            <label for="type" class="col-form-label">Turi <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
            <label for="inputTitle" class="col-form-label">Qiymat <span class="text-danger">*</span></label>
