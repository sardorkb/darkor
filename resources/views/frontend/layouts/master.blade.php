        ...
        <div id="loading-center">
            <div id="loading-center-absolute">
                <svg viewBox="0 0 58 58" id="mustard" class="product">
                    <g>
                    <path style="fill:#077fa1;" d="M39.869,58H18.131C16.954,58,16,57.046,16,55.869V12.621C16,11.726,16.726,11,17.621,11h22.757
                    ...
                    <rect x="16" y="16" style="fill:#077fa1;" width="26" height="2" />
                    <rect x="20" y="11" style="fill:#077fa1;" width="2" height="6" />
                    <rect x="25" y="11" style="fill:#077fa1;" width="2" height="6" />
                    <rect x="30" y="11" style="fill:#077fa1;" width="2" height="6" />
                    <rect x="36" y="11" style="fill:#077fa1;" width="2" height="6" />
                ...
                <svg viewBox="0 0 49.818 49.818" id="meat" class="product">
                    ...
                    <g>
                        <path style="fill:#077fa1;" d="M4.69,37.18c0.402,0.785,3.058,5.552,9.111,7.554c1.335,0.441,2.863,0.577,4.482,0.72l0.282,0.025
                ...
                <div class="cart-container">
                    ...
                    <polygon style="fill:#045970;" points="250.4,49.6 224,124.8 411.2,124.8 " />
                    <polygon style="fill:#077fa1;" points="411.2,124.8 224,124.8 170.4,124.8 136.8,124.8 68,124.8 141.6,361.6 427.2,361.6 
                    511.2,124.8 " />
                    <g>
